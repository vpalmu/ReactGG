# MANAGING EFFECTS – PART 2 Poke API
* Implementation of React App that calls https://pokeapi.co/api/v2/pokemon/
and displays retured pokemon image. Demonstrates use of components, state and hooks.


## Three rules for managing effects in React
